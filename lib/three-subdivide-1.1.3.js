...
class LoopSubdivision {
    ...
    static edgeSplit(geometry) {
        ...
        attributeList.forEach((attributeName) => {
            ...
            split.addAttribute(attributeName, new THREE.BufferAttribute(floatArray, attribute.itemSize));
        });
    ...
    static flat(geometry, params = {}) {
        ...
        attributeList.forEach((attributeName) => {
            ...
            loop.addAttribute(attributeName, LoopSubdivision.flatAttribute(attribute, vertexCount, params));
        });
    ...
    static smooth(geometry, params = {}) {
        ...
        attributeList.forEach((attributeName) => {
            ...
            loop.addAttribute(attributeName, new THREE.BufferAttribute(floatArray, flattenedAttribute.itemSize));
        });
