...
**big-6.2.1.mjs**<br>Copyright © `<2022>` `Michael Mclaughlin`<br>https://github.com/MikeMcl/big.js<br>License: [MIT](licenses/big-6.2.1.mjs.txt)<br>Notes: A small, fast JavaScript library for arbitrary-precision decimal arithmetic.<br>Used by: &#8234;Bumper&#8236;
...
**fluent-bundle-0.18.0**<br>Copyright 2013 Mozilla Foundation and others<br>https://projectfluent.org/<br>License: [Apache 2.0](licenses/fluent-bundle-0.18.0.txt)<br>Notes: Used for formatting complex string patterns and supporting translations.<br>Used by: &#8234;Bumper&#8236;
