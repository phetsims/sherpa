...
**easing-equations**<br>Copyright (c) 2001 Robert Penner. All rights reserved<br>http://robertpenner.com/easing/<br>License: [Revised BSD](licenses/easing-equations.txt)<br>Notes: Easing equations used in Tween.js, used to animate some graphics
