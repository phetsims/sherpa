...
module.exports = function( grunt ) {
  var licenseInfo = {
    ...
    'has': {
      text: 'has.js\n' +
            'Copyright (c) 2010-2013 John David Dalton, Brad Dougherty, Bryan Forbes, Ryan Grove, Andrée Hansson, Peter Higgins, Paul Irish, Weston Ruter, Rick Waldron, Juriy Zaytsev\n' +
    ...
    'iframe-phone-7680a25185': {
      text: 'iframe-phone.js\n' +
            'Copyright (c) 2014 Concord Consortium',
      usage: [ 'development' ],
      notes: 'used in codap experiments.  No version was listed, so I used the GitHub git SHA',
      selectedLicense: 'MIT'
    },
    'jquery-2.1.0': {
      text: 'jQuery JavaScript Library v2.1.0 (includes Sizzle.js)\n' +
    ...
    'jshint-2.5.0': {
      text: 'jshint 2.5.0\n' +
            'Copyright 2012 Anton Kovalyov (http://jshint.com) MIT License, https://github.com/jshint/jshint/blob/master/LICENSE',
      usage: [ 'development' ],
      notes: ''
    },
    'jsondiffpatch-0.1.31': {
      text: 'jsondiffpatch 0.1.31\n' +
    ...
    'require-i18n': {
      text: 'RequireJS requirejs-i18n - AMD loader for localization string resources\n' +
    ...
    'typedarray': {
      text: 'typedarray\n' +
            'Copyright &copy; 2010 Linden Research, Inc., Copyright &copy; 2014 Joshua Bell',
      usage: [ 'sim' ],
      notes: 'Typed array polyfill',
      selectedLicense: 'MIT'
    },
    'Tween-r12': {
      text: 'Tween.js r12 - http://github.com/sole/tween.js\n' +
            'The MIT License\n' +
